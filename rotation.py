...
st.title("🕶️ GENTLE MONSTER 전사 통합 로테이션 (v36.0)")
    ...
    for slot in time_slots:
        ...
        for z in target_zones:
            ...
            if chosen:
                ...
                if chosen in counter_pool: counter_pool.pop(counter_pool.index(chosen))
...
if st.sidebar.button("🚀 로테이션 생성"):
    st.session_state.df = generate_v36()
