...
st.title("🕶️ GENTLE MONSTER 전사 통합 로테이션 (v22.1)")
...
# 4. 상세 설정 (⭐ 에러 수정 포인트: enumerate 활용)
group_configs = {}
...
if st.sidebar.button("🚀 로테이션 생성"):
    st.session_state.df = generate_v22_1()
